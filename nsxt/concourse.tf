# From https://docs.pivotal.io/p-concourse/v6/installation/install-platform-automation/
#
# Add these without affecting others by
# terraform plan -target nsxt_lb_service.concourse_lb_service
